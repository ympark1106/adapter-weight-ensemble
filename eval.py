...
def train():
    ...
    # state_dict = torch.load(os.path.join(save_path, 'cyclic_checkpoint_epoch169.pth'), map_location='cpu')
    # state_dict = torch.load(os.path.join(save_path, 'swa_model_final.pth'), map_location='cpu')
    # state_dict = torch.load(os.path.join(save_path, 'swag_final_weights.pth'), map_location='cpu')
