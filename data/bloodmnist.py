...
def get_dataloader(batch_size: int = 32, download: bool = True, num_workers: int = 4):
    ...
    train_dataset = BloodMNIST(root='data', split='train', transform=train_transforms, download=download, size=224)
    valid_dataset = BloodMNIST(root='data', split='val', transform=test_transforms, download=download, size=224)
    test_dataset = BloodMNIST(root='data', split='test', transform=test_transforms, download=download, size=224)
