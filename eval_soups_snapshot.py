...
def train():
    ...
    save_paths = [
        ...
        # os.path.join(config['save_path'], 'reins_focal_hydra_3/cyclic_checkpoint_epoch89.pth'),
        # os.path.join(config['save_path'], 'reins_focal_hydra_3/cyclic_checkpoint_epoch119.pth'),
        # os.path.join(config['save_path'], 'reins_focal_hydra_3/cyclic_checkpoint_epoch149.pth'),
        # os.path.join(config['save_path'], 'reins_focal_hydra_3/cyclic_checkpoint_epoch179.pth'),
        # os.path.join(config['save_path'], 'reins_focal_hydra_3/cyclic_checkpoint_epoch209.pth'),
        # os.path.join(config['save_path'], 'reins_focal_hydra_3/cyclic_checkpoint_epoch239.pth'),
