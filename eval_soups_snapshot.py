...
import rein
from losses import RankMixup_MNDCG, RankMixup_MRL, focal_loss
...
def train():
    ...
    save_paths = [
        ...
        os.path.join(save_path, 'cyclic_checkpoint_epoch99.pth'),
        os.path.join(save_path, 'cyclic_checkpoint_epoch129.pth'),
        os.path.join(save_path, 'cyclic_checkpoint_epoch159.pth'),
        os.path.join(save_path, 'cyclic_checkpoint_epoch189.pth'),
        os.path.join(save_path, 'cyclic_checkpoint_epoch219.pth'),
